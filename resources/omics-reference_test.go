...
type TestOmicsReferenceSuite struct {
	suite.Suite
	svc              *omics.Client
	referenceStoreID *string
}

func (s *TestOmicsReferenceSuite) SetupSuite() {
	ctx := context.TODO()
	...
	storeName := ptr.String(fmt.Sprintf("aws-nuke-test-ref-%d", time.Now().UnixNano()))
...
func (s *TestOmicsReferenceSuite) TearDownSuite() {
	ctx := context.TODO()
...
func (s *TestOmicsReferenceSuite) TestList() {
...
func TestOmicsReferenceIntegration(t *testing.T) {
	suite.Run(t, new(TestOmicsReferenceSuite))
}
